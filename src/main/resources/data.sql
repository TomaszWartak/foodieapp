INSERT INTO
    item(id, price, name, short_description, description, picture_address)
VALUES
    ...
    (2, 25.99, 'Pizza Capriciosa', 'Pizza na cienkim cieście z serem, sosem pomidorowym i pieczarkami',
     ...
     'domowego sosu pomidorowego i oryginalnej włoskiej mozarelli znajdziesz tutaj także pieczarki i wyśmienitą sznkę.', '/img/capriciosa.jpg'),
